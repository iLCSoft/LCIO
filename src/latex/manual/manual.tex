...
In particular it does not yet contain the reconstruction data model (Tracks, Clusters and ReconstructedParticles).
Please do not use v1.3beta for producing large amounts of data.
}
...
\ref{fig_evtdata} for details on the data entities.) The LCRunHeader is used to store run related 
...
point position and error matrix, computed from the raw data.
