...
%\title{LCIO [v01-03beta] -  Users manual}
\title{{\Huge\bf LCIO  -  Users manual} \\ v01-03beta}
...
\begin{verbatim}
  mkdir lcio 
  cd lcio
  cvs co -d v01-03beta -r v01-03beta lcio
\end{verbatim}
...
\begin{verbatim} 
  export LCIO=/lcio/v01-03beta                <-- modify as appropriate
...
\begin{verbatim}
  ...
  set LCIO=c:/lcio/devel/v01-03beta            <-- modify as appropriate
...
\begin{verbatim}
  export LCIO=/cygdrive/c/lcio/devel/v01-03beta   <-- modify as appropriate
  export PATH=$LCIO/tools:$LCIO/bin:$PATH
...
Clusters allowing a tree-like structure, e.g. one could buikd clusters with a geometrical algorithm and then
