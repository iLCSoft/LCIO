...
%\title{LCIO [v1.1] -  Users manual}
\title{{\Huge\bf LCIO  -  Users manual} \\ Version 1.1}
...
\begin{verbatim} 
  export LCIO=/lcio/v1.1                <-- modify as appropriate
...
\begin{verbatim}
  ...
  set LCIO=c:/lcio/devel/v1.1            <-- modify as appropriate
...
\begin{verbatim}
  export LCIO=c:/lcio/devel/v1.1
  export PATH=/cygdrive/c/lcio/devel/v1.1/tools:\
              /cygdrive/c/lcio/devel/v1.1/bin:$PATH
