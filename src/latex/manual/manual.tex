...
%\title{LCIO [v1.1beta+] -  Users manual}
\title{{\Huge\bf LCIO  -  Users manual} \\ v1.1beta+}
...
{\bf This document is not yet fully updated to the version 1.1 that is to be released soon.
In particular it does not yet contain the reconstruction data model (Tracks, Clusters and ReconstructedParticles). Please do not use v1.1beta for producing large amounts of data.
}
...
\begin{verbatim}
  mkdir lcio 
  cd lcio
  cvs co -d v1.1beta -r v1.1beta lcio
\end{verbatim}
...
\begin{verbatim} 
  export LCIO=/lcio/v1.1beta                <-- modify as appropriate
...
\begin{verbatim}
  ...
  set LCIO=c:/lcio/devel/v1.1beta            <-- modify as appropriate
...
\begin{verbatim}
  export LCIO=c:/lcio/devel/v1.1beta
  export PATH=/cygdrive/c/lcio/devel/v1.1beta/tools:\
              /cygdrive/c/lcio/devel/v1.1beta/bin:$PATH
...
\rule[-5mm]{0mm}{10mm} C++ Namespace  &  Java package    &  Purpose \\ \hline \hline
 ...
 DATA  &  hep.lcio.data   & Has been removed in v1.1\\ \hline
 EVENT  &  hep.lcio.event   & The base interfaces of all data classes in LCIO.
 \\ \hline
...
\caption{Overview of the data model defined by LCIO (all classes in namespace EVENT). 
