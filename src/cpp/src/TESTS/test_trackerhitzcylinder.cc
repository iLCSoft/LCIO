...
const static string testname="test_trackerhitzcylinder";
...
int main(int /*argc*/, char** /*argv*/ ){
    ...
    try{
        ...
        MYTEST.LOG( " writing TrackerZCylinderHits " );
        ...
        for(int i=0;i<NEVENT;i++){
            ...
            LCCollectionVec* trkHits = new LCCollectionVec( LCIO::TRACKERHITZCYLINDER )  ;
            ...
            evt->addCollection( trkHits , "TrackerZCylinderHits") ;
        ...
        MYTEST.LOG(" reading back TrackerZCylinderHits from file " ) ;
        ...
        for(int i=0;i<NEVENT;i++){
            ...
            LCCollection* trkHits = evt->getCollection( "TrackerZCylinderHits") ;
