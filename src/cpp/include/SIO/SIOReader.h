 ...
 */
  ...
  public:
     ...
     * @throws IOException
     */
    virtual EVENT::LCRunHeader * readNextRunHeader() noexcept(false) ;
     ...
     * @throws IOException
     */
    virtual EVENT::LCRunHeader * readNextRunHeader(int accessMode) noexcept(false) ;
     ...
     * @throws IOException
     */
    virtual EVENT::LCEvent* readNextEvent() noexcept(false) ;
     ...
     * @throws IOException
     */
    virtual EVENT::LCEvent* readNextEvent( int accessMode) noexcept(false) ;
     ...
     */
   virtual int getNumberOfEvents() noexcept(false) ;
     ...
     */
    virtual int getNumberOfRuns() noexcept(false) ;
    ...
    /** Skips the next n events from the current position. In fact simply reads the next n
      ...
      */
    virtual void skipNEvents(int n)   noexcept(false)  ;
     ...
     */
    virtual void readStream() noexcept(false) ;
     ...
     * @throws EndOfException
     */
    virtual void readStream(int maxRecord) noexcept(false) ;
  ...
  protected:
    ...
    void setUpHandlers() ;
    void readRecord() noexcept(false) ;
