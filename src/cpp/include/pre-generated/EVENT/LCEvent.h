...
public: 
     ...
     */
    virtual LCCollection * getCollection(const std::string & name) const noexcept(false) = 0;
     ...
     * @throws DataNotAvailableException
     */
    virtual LCCollection * takeCollection(const std::string & name) const noexcept(false) = 0;
     ...
     */ 
    virtual void addCollection(LCCollection * col, const std::string & name) noexcept(false) = 0;
     ...
     */ 
    virtual void removeCollection(const std::string & name) noexcept(false) = 0;
