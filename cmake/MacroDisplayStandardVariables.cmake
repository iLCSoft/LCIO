...
MACRO( DISPLAY_STD_VARIABLES )
    ...
    IF( DEFINED CMAKE_PREFIX_PATH )
        ...
        FOREACH( _path ${CMAKE_PREFIX_PATH} )
            LIST(APPEND LCIO_PREFIX_PATH "${_path}\n")
        ENDFOREACH()
        MESSAGE( STATUS "CMAKE_PREFIX_PATH = ${LCIO_PREFIX_PATH}" )
    ...
    IF( DEFINED CMAKE_MODULE_PATH )
        ...
        FOREACH( _path ${CMAKE_MODULE_PATH} )
            LIST(APPEND LCIO_MODULE_PATH "${_path}\n")
        ENDFOREACH()
        MESSAGE( STATUS "CMAKE_MODULE_PATH = ${LCIO_MODULE_PATH}" )
