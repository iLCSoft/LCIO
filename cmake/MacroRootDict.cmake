...
IF( NOT DEFINED ROOT_DICT_OUTPUT_DIR )
    SET( ROOT_DICT_OUTPUT_DIR "${PROJECT_BINARY_DIR}/lib" )
ENDIF()
...
IF( NOT ROOT_FIND_QUIETLY )
    MESSAGE( STATUS "Check for ROOT_DICT_OUTPUT_DIR: ${PROJECT_BINARY_DIR}/lib" )
...
MACRO( GEN_ROOT_DICT_SOURCE _dict_src_filename )
    ...
    ADD_CUSTOM_COMMAND(
        ...
        COMMAND mkdir -p ${ROOT_DICT_OUTPUT_DIR}
        COMMAND ${ROOT_rootcint_CMD} -f "${_dict_src_file}" ${ROOT_DICT_CINT_DEFINITIONS} ${_dict_includes} ${ROOT_DICT_INPUT_HEADERS}
