IF( NOT DEFINED ROOT_DICT_OUTPUT_DIR )
    SET( ROOT_DICT_OUTPUT_DIR "${PROJECT_BINARY_DIR}/${CMAKE_INSTALL_LIBDIR}" )
ENDIF()
...
IF( NOT ROOT_FIND_QUIETLY )
    MESSAGE( STATUS "Check for ROOT_DICT_OUTPUT_DIR: ${PROJECT_BINARY_DIR}/${CMAKE_INSTALL_LIBDIR}" )
...
MACRO( GEN_ROOT_DICT_LINKDEF_HEADER _namespace )
    ...
    FOREACH( _header ${_input_headers} )
        ...
        SET( ${_namespace}_file_contents "${${_namespace}_file_contents}\\#pragma link C++ defined_in \\\"${_dict_header}\\\"\\;\\\\n" )
    ENDFOREACH()
